...
### Getting started
1. [Programming exercise: Emoticon](part01/1.gettingStarted/1.emoticon.py)
2. [Programming exercise: Fix the code: Seven Brothers](part01/1.gettingStarted/2.fixTheCodeSevenBrothers.py)
